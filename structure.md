...
![img](image/structure/1652247741410.png)![](image/structure/1652248837698.png)
...
-FREQUENCY 频率。这个在这里有啥用还没怎么搞明白，不过按行业规定，频段都是分配给定的，因此调整此参数意义不大。
...
keepSendingIncreasing是核心函数，建议自己也看看。

## main.py：主程序

建议自己也看看，顶层很好懂，注释我也写了。
